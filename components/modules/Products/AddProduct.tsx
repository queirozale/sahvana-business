...
//   const handleSizeChange = (event: { target: HTMLInputElement; }) => {
//     setSize(event.target.value);
//   };

//   const handleGenderChange = (event: { target: HTMLInputElement; }) => {
//     setGender(event.target.value);
//   };

//   const handleServerResponse = (ok: boolean, form) => {
//     setServerState({
//       submitting: false,
//       status: { ok }
//     });
...
//   const registerProduct = async (event: { target: HTMLInputElement; }) => {
